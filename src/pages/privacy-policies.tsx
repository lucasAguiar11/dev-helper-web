  ...
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 my-10">
      ...
      <p className="text-gray-800 text-justify">
        ...
        sejam armazenados, no entanto, isso pode fazer o downgrade ou 'quebrar' certos elementos da
      ...
      <p className="text-gray-800 text-justify">
        ...
        usados ​​para fornecer um serviço que você usa.
      </p>
      ...
      <h3 className="text-xl font-bold tracking-tight text-gray-800 my-5">Cookies de Terceiros</h3>
      <p className="text-gray-800 text-justify">
      ...
      <p className="text-gray-800 text-justify">
        O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Dev Helper
      ...
      <p className="text-gray-800 text-justify">
        ...
        Helper , de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos

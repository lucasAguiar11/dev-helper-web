  ...
  return (
    <>
      <Metadata
        ...
        description="Encontre aqui a nossa política de privacidade."
        canonical="/terms"
      />
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 my-10">
        <div className="flex flex-col border-b border-gray-200 pt-2 pb-6">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900">Política Privacidade</h1>
        </div>
        <p className="text-gray-800 pt-5 text-justify">
          A sua privacidade é importante para nós. É política do Dev Helper respeitar a sua
          privacidade em relação a qualquer informação sua que possamos coletar no site{' '}
          <a href="https://dev-helper.com.br">Dev Helper </a>, e outros sites que possuímos e
          operamos.
        </p>
        ...
        <p className="text-gray-800 text-justify">
          ...
          <a href="https://privacidade.me/" target="_BLANK" rel="noreferrer">
        ...
        <h1 className="text-2xl my-5 font-bold tracking-tight text-gray-900">
          Política de Cookies Dev Helper{' '}
        </h1>
        <h3 className="text-xl font-bold tracking-tight text-gray-800 my-5">O que são cookies?</h3>
        <p className="text-gray-800 text-justify">
          ...
          sejam armazenados, no entanto, isso pode fazer o downgrade ou 'quebrar' certos elementos
          da funcionalidade do site.
        </p>
        <h3 className="text-xl font-bold tracking-tight text-gray-800 my-5">
        ...
        <h3 className="text-xl font-bold tracking-tight text-gray-800 my-5">Desativar cookies</h3>
        <p className="text-gray-800 text-justify">
        ...
        <p className="text-gray-800 text-justify">
          ...
          melhorar sua experiência. Esses cookies podem rastrear itens como quanto tempo você gasta
          no site e as páginas visitadas, para que possamos continuar produzindo conteúdo atraente.
        </p>
        <p className="text-gray-800 text-justify">
        ...
        <p className="text-gray-800 text-justify">
          O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Dev
          Helper oferece no site e com caráter enunciativo, mas não limitativo:
        </p>
        <p className="text-gray-800 text-justify">
          <b>A)</b> Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem
          pública;
        </p>

        <p className="text-gray-800 text-justify">
          <b>B)</b> Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou casas de
          apostas, jogos de sorte e azar, qualquer tipo de pornografia ilegal, de apologia ao
          terrorismo ou contra os direitos humanos;
        </p>

        <p className="text-gray-800 text-justify">
          <b>C)</b> Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Dev
          Helper , de seus fornecedores ou terceiros, para introduzir ou disseminar vírus
        ...
        <h3 className="text-xl font-bold tracking-tight text-gray-800 my-5">Mais informações</h3>
        <p className="text-gray-800 text-justify">
        ...
        <p className="text-gray-800 text-justify">
          Esta política é efetiva a partir de <strong>Nov</strong>/<strong>2022</strong>.
        </p>
      </section>
    </>
  )

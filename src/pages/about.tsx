  ...
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-10 h-screen">
      ...
      <p className="text-gray-600 pt-5 text-justify">
        ...
        para ajudar estudantes de programação, programadores, analistas e testadores software no seu
        dia a dia.
      </p>
      ...
      <p className="text-gray-600 pt-5 text-justify">
        ...
        fornecidos sem qualquer tipo de garantia. Todo e qualquer risco da utilização dos conteúdos
